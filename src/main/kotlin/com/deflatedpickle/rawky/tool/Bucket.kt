...
class Bucket : HoverOutlineTool(null, "Bucket", listOf(Icons.bucket), Icons.bucket.image, false) {
    override fun perform(button: Int, dragged: Boolean, point: Point, lastPoint: Point?, clickCount: Int) {
        val pixel = object : Toolbox.LockCheck(this.name) {
            ...
            override fun perform() {
                ...
                // PixelGrid.frameList[frame].layerList[layer].pixelMatrix[currentRow][currentColumn]
